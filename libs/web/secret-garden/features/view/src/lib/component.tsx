...
export function SecretGardenView(): ReactElement {
  const isEventStarted = new Date() > new Date(secretGardenConfig.eventDate);
  ...
  return (
    <div className='home min-h-screen no-scrollbar'>
      <div className='relative w-full h-screen'>
        ...
        <CountdownTimer className='w-[220px] fixed bottom-[140px] md:bottom-[100px] left-0 md:left-[unset] right-0 md:right-[100px] mx-auto md:mx-0' />
        <AppAudioPlayer playList={secretGardenConfig.playlist} shouldAutoplay />
      </div>
    </div> 
  );
}
